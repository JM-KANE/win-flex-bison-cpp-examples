...
/**
 ** \file simple.hpp
 ** Define the simple::parser class.
 */
...
#ifndef YY_YY_SIMPLE_HPP_INCLUDED
# define YY_YY_SIMPLE_HPP_INCLUDED
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::size_t&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::size_t& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#line 1368 "simple.hpp"




#endif // !YY_YY_SIMPLE_HPP_INCLUDED
