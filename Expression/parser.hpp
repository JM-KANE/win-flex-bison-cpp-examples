...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_SCOLON = 12,               // ";"
    TOK_DEF = 13,                  // "def"
    TOK_IDENTIFIER = 14,           // "identifier"
    TOK_NUMBER = 15                // "number"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_unit = 17,                             // unit
        S_statements = 18,                       // statements
        S_statement = 19,                        // statement
        S_assignment = 20,                       // assignment
        S_declaration = 21,                      // declaration
        S_exp = 22,                              // exp
        S_add_sub = 23,                          // add_sub
        S_signed = 24,                           // signed
        S_multi_div = 25,                        // multi_div
        S_pow = 26,                              // pow
        S_atom = 27                              // atom
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOK_TRI, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_TRI, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_SCOLON, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_SCOLON, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
